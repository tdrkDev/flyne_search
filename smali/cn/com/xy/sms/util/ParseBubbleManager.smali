...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/com/xy/sms/util/ParseBubbleManager;->a:Ljava/lang/String;
...
.method private static a()I
    ...
    invoke-virtual {v2, v3, v4}, Lcn/com/xy/sms/sdk/action/AbsSdkDoAction;->getConfig(ILjava/util/Map;)Ljava/lang/String;
...
.method static synthetic a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/util/Map;)Lorg/json/JSONArray;
    .locals 2

    invoke-static/range {p0 .. p6}, Lcn/com/xy/sms/util/ParseBubbleManager;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/util/Map;)Lorg/json/JSONArray;
...
.method private static a(Lcn/com/xy/sms/sdk/util/D;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcn/com/xy/sms/sdk/util/D;",
            "Ljava/util/Map",
            "<",
            "Ljava/lang/String;",
    ...
    iget-object v1, p0, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;
    ...
    iget-object v1, p0, Lcn/com/xy/sms/sdk/util/D;->k:Ljava/util/Map;

    monitor-enter v1

    :try_start_1
    iget-object v0, p0, Lcn/com/xy/sms/sdk/util/D;->k:Ljava/util/Map;
...
.method private static a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v7}, Lcn/com/xy/sms/util/d;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method private static a(ZLjava/lang/String;)V
    ...
    invoke-static {p1}, Lcn/com/xy/sms/sdk/util/D;->c(Ljava/lang/String;)V
...
.method public static addEffectiveBubbleData(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONArray;)V
    ...
    iget-object v1, v0, Lcn/com/xy/sms/sdk/util/D;->c:Ljava/util/Map;

    monitor-enter v1

    :try_start_0
    iget-object v2, v0, Lcn/com/xy/sms/sdk/util/D;->c:Ljava/util/Map;
    ...
    iget-object v1, v0, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;

    monitor-enter v1

    :try_start_1
    iget-object v2, v0, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;
    ...
    iget-object v1, v0, Lcn/com/xy/sms/sdk/util/D;->d:Ljava/util/HashSet;

    monitor-enter v1

    :try_start_2
    iget-object v2, v0, Lcn/com/xy/sms/sdk/util/D;->d:Ljava/util/HashSet;
    ...
    iget-object v1, v0, Lcn/com/xy/sms/sdk/util/D;->e:Ljava/util/HashSet;
...
.method public static addInvalidBubbleData(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_2
    iget-object v2, v0, Lcn/com/xy/sms/sdk/util/D;->e:Ljava/util/HashSet;
    ...
    :try_start_3
    iget-object v0, v0, Lcn/com/xy/sms/sdk/util/D;->c:Ljava/util/Map;
...
.method private static b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLjava/util/Map;)Lorg/json/JSONArray;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static deleteBubbleData(Ljava/lang/String;)I
    ...
    invoke-virtual {v0}, Lcn/com/xy/sms/sdk/util/D;->c()V
...
.method public static deleteBubbleData(Ljava/util/Set;)V
    ...
    new-instance v1, Lcn/com/xy/sms/util/e;

    invoke-direct {v1, p0}, Lcn/com/xy/sms/util/e;-><init>(Ljava/util/Set;)V
...
.method public static equalPhoneNum(Ljava/lang/String;)Z
    ...
    sget-object v0, Lcn/com/xy/sms/util/ParseBubbleManager;->a:Ljava/lang/String;
    ...
    sget-object v1, Lcn/com/xy/sms/util/ParseBubbleManager;->a:Ljava/lang/String;
...
.method public static loadBubbleDataByPhoneNum(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, p1, v0}, Lcn/com/xy/sms/util/ParseBubbleManager;->loadBubbleDataByPhoneNum(Ljava/lang/String;ZZ)V

    return-void
.end method

.method public static loadBubbleDataByPhoneNum(Ljava/lang/String;ZZ)V
    .locals 7
    ...
    invoke-static {v0}, Lcn/com/xy/sms/sdk/util/D;->b(Ljava/lang/String;)Lcn/com/xy/sms/sdk/util/D;

    move-result-object v3

    iget-object v4, v3, Lcn/com/xy/sms/sdk/util/D;->c:Ljava/util/Map;
    ...
    const-string v4, "save_time desc"
    ...
    invoke-static {v3, v4}, Lcn/com/xy/sms/util/ParseBubbleManager;->a(Lcn/com/xy/sms/sdk/util/D;Ljava/util/Map;)V

    if-eqz p1, :cond_0

    invoke-static {v0, v4, v6}, Lcn/com/xy/sms/util/ParseRichBubbleManager;->pubBubbleData(Ljava/lang/String;Ljava/util/Map;Z)V

    :cond_0
    if-eqz p2, :cond_1

    invoke-static {v0, v4, v6}, Lcn/com/xy/sms/util/ParseMsgUrlManager;->putUrlsResultData(Ljava/lang/String;Ljava/util/Map;Z)V

    :cond_1
    invoke-static {v1, v2, p1, v3, v0}, Lcn/com/xy/sms/util/ParseBubbleManager;->loadBubbleDataByPhoneNumSecond(Ljava/lang/String;[Ljava/lang/String;ZLcn/com/xy/sms/sdk/util/D;Ljava/lang/String;)V

    invoke-static {}, Lcn/com/xy/sms/util/ParseBubbleManager;->a()I

    move-result v1

    const/4 v2, 0x3

    invoke-static {v0, v1, v2, v6}, Lcn/com/xy/sms/util/ParseSmsToBubbleUtil;->beforeHandParseReceiveSms(Ljava/lang/String;IIZ)V
...
.method public static loadBubbleDataByPhoneNumSecond(Ljava/lang/String;[Ljava/lang/String;ZLcn/com/xy/sms/sdk/util/D;Ljava/lang/String;)V
    .locals 2
    ...
    :goto_0
    const-string v0, "save_time desc"
    ...
    invoke-static {p3, v0}, Lcn/com/xy/sms/util/ParseBubbleManager;->a(Lcn/com/xy/sms/sdk/util/D;Ljava/util/Map;)V

    if-eqz p2, :cond_0

    const/4 v1, 0x0

    invoke-static {p4, v0, v1}, Lcn/com/xy/sms/util/ParseRichBubbleManager;->pubBubbleData(Ljava/lang/String;Ljava/util/Map;Z)V
...
.method public static parseMsgToSimpleBubbleResultKuai(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JBLjava/util/Map;)Ljava/lang/String;
    ...
    sget-object v2, Lcn/com/xy/sms/sdk/a/a;->e:Ljava/util/concurrent/ExecutorService;

    new-instance v3, Lcn/com/xy/sms/util/d;
    ...
    invoke-direct/range {v3 .. v9}, Lcn/com/xy/sms/util/d;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
...
.method public static queryDataByMsgItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJ)Lorg/json/JSONObject;
    ...
    iget-object v1, v3, Lcn/com/xy/sms/sdk/util/D;->b:Ljava/util/Map;

    if-eqz v1, :cond_4

    iget-object v0, v3, Lcn/com/xy/sms/sdk/util/D;->b:Ljava/util/Map;
    ...
    iget-object v1, v3, Lcn/com/xy/sms/sdk/util/D;->d:Ljava/util/HashSet;
    ...
    iget-object v1, v3, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;

    if-eqz v1, :cond_b

    iget-object v0, v3, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;
    ...
    :goto_1
    iget-object v2, v3, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;
    ...
    iget-object v0, v3, Lcn/com/xy/sms/sdk/util/D;->e:Ljava/util/HashSet;
...
.method public static queryDataByMsgItem(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJLcn/com/xy/sms/util/SdkCallBack;ZLjava/util/Map;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v3, v4, Lcn/com/xy/sms/sdk/util/D;->c:Ljava/util/Map;

    if-eqz v3, :cond_3

    iget-object v2, v4, Lcn/com/xy/sms/sdk/util/D;->c:Ljava/util/Map;
    ...
    iget-object v3, v4, Lcn/com/xy/sms/sdk/util/D;->d:Ljava/util/HashSet;
    ...
    const-string v4, " invalidBubbleData "
    ...
    iget-object v2, v4, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;
    ...
    const-string v5, "need_parse_simple"
    ...
    iget-object v2, v4, Lcn/com/xy/sms/sdk/util/D;->d:Ljava/util/HashSet;
    ...
    :goto_1
    iget-object v3, v4, Lcn/com/xy/sms/sdk/util/D;->a:Ljava/util/Map;
    ...
    :cond_5
    iget-object v2, v4, Lcn/com/xy/sms/sdk/util/D;->e:Ljava/util/HashSet;
    ...
    invoke-direct/range {v3 .. v13}, Lcn/com/xy/sms/util/c;-><init>(Lcn/com/xy/sms/sdk/util/D;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JLcn/com/xy/sms/util/SdkCallBack;Ljava/lang/String;Ljava/util/Map;I)V
