...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/com/xy/sms/sdk/util/XyUtil;->b:Lorg/json/JSONObject;
...
.method private static a(Ljava/util/Map;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :cond_e
    const-string v2, "WEB_TRAFFIC_ORDER"
    ...
    :cond_f
    :try_start_2
    const-string v2, "WEB_INSTALMENT_PLAN"
    ...
    const-string v1, "budgetSmsTemplate"

    const-string v2, "budgetSmsTemplate"
...
.method public static chmod(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p1}, Lcn/com/xy/sms/sdk/util/H;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static decompressBytes([B)[B
    ...
    invoke-virtual {v3, v4, v8, v5}, Ljava/io/ByteArrayOutputStream;->write([BII)V

    :cond_4
    rem-int/lit16 v5, v1, 0xc8
...
.method public static getLineByCompressFile(Ljava/lang/String;)Ljava/io/LineNumberReader;
    ...
    :try_start_0
    invoke-static {p0}, Lcn/com/xy/sms/sdk/util/f;->e(Ljava/lang/String;)[B
...
.method public static declared-synchronized getLoaction()Lorg/json/JSONObject;
    .locals 3

    const-class v1, Lcn/com/xy/sms/sdk/util/XyUtil;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcn/com/xy/sms/sdk/util/XyUtil;->b:Lorg/json/JSONObject;
    ...
    sput-object v2, Lcn/com/xy/sms/sdk/util/XyUtil;->b:Lorg/json/JSONObject;
    :try_end_1
    .catch Ljava/lang/Throwable; {:try_start_1 .. :try_end_1} :catch_0
...
.method public static getSceneServiceAction(Ljava/util/Map;)Ljava/lang/String;
    ...
    const-string v1, "display_scene_result"
    ...
    const-string v0, "RECOGNIZE_LEVEL"
    ...
    const-string v2, "display_scene_result"
...
.method public static getXyValue()Ljava/lang/String;
    .locals 1
    ...
    invoke-static {}, Lcn/com/xy/sms/sdk/util/PopupUtil;->getValue()Ljava/lang/String;
...
.method public static isFlagOn(Ljava/lang/String;Ljava/util/Map;)Z
    .locals 2
...
.method public static removeAreaCodeInfo()V
    .locals 2
...
.method public static removeLoactionInfo()V
    .locals 2
...
.method public static setLoaction(Lorg/json/JSONObject;)V
    .locals 0

    sput-object p0, Lcn/com/xy/sms/sdk/util/XyUtil;->b:Lorg/json/JSONObject;

    return-void
.end method

.method public static setLoactionInfo(DD)V
    .locals 4
...
.method public static upZipFile(Ljava/io/File;Ljava/lang/String;ZLjava/lang/String;Z)V
    ...
    invoke-static {v4}, Lcn/com/xy/sms/sdk/util/f;->a(Ljava/util/zip/ZipFile;)V
    ...
    invoke-static {v6}, Lcn/com/xy/sms/sdk/db/entity/h;->c(Ljava/lang/String;)I

    move-result v7

    invoke-static {v6, p3, v7}, Lcn/com/xy/sms/sdk/db/entity/h;->a(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v8, "upZipFile is dir: "
    ...
    invoke-virtual {v0, v2, v6, v7}, Lcn/com/xy/sms/sdk/action/AbsSdkDoAction;->logInfo(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_3
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_3} :catch_0
    ...
    :goto_2
    invoke-static {v2}, Lcn/com/xy/sms/sdk/util/f;->a(Ljava/util/zip/ZipFile;)V
...
.method public static upZipFile(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 10
    ...
    :goto_4
    invoke-static {v3}, Lcn/com/xy/sms/sdk/util/f;->a(Ljava/util/zip/ZipFile;)V
