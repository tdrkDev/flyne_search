...
.method public static a(I)Lorg/json/JSONArray;
    ...
    const-string v2, "res_type = ? and down_statu = ? "
    ...
    const-string v3, "down_statu"

    aput-object v3, v1, v0

    const/4 v0, 0x5

    const-string v3, "temp_filename"

    aput-object v3, v1, v0

    const/4 v0, 0x6

    const-string v3, "down_failed_time"

    aput-object v3, v1, v0

    const-string v0, "tb_resourse_queue"
    ...
    const-string v6, "res_version asc"
    ...
    const-string v0, "down_statu"

    invoke-virtual {v1, v0}, Lcn/com/xy/sms/sdk/db/XyCursor;->getColumnIndex(Ljava/lang/String;)I

    move-result v6

    const-string v0, "temp_filename"

    invoke-virtual {v1, v0}, Lcn/com/xy/sms/sdk/db/XyCursor;->getColumnIndex(Ljava/lang/String;)I

    move-result v7

    const-string v0, "down_failed_time"
    ...
    :goto_1
    invoke-static {v1, v14}, Lcn/com/xy/sms/sdk/db/XyCursor;->closeCursor(Lcn/com/xy/sms/sdk/db/XyCursor;Z)V
    ...
    const-string v10, "temp_filename"

    invoke-virtual {v1, v7}, Lcn/com/xy/sms/sdk/db/XyCursor;->getString(I)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v8, v10, v11}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v10, "down_failed_time"
...
.method public static a(Ljava/lang/Integer;ZLjava/lang/String;)V
    ...
    const-string v1, "down_failed_time"

    const-string v2, "0"

    invoke-virtual {v0, v1, v2}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "down_statu"
    ...
    :goto_0
    const-string v1, "tb_resourse_queue"
...
.method public static a(Lorg/json/JSONArray;)V
    ...
    const-string v0, "del_history"

    invoke-static {v6, v0}, Lcn/com/xy/sms/sdk/util/JsonUtil;->getValueFromJsonObject(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {v6, v1}, Lcn/com/xy/sms/sdk/util/JsonUtil;->getValueFromJsonObject(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ljava/lang/String;

    const-string v2, "tb_resourse_queue"

    const-string v3, "res_type = ? and res_version < ?"
    ...
    invoke-static {v2, v3, v7}, Lcn/com/xy/sms/sdk/db/DBManager;->delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v3, "tb_resourse_queue"
    ...
    const-string v8, "res_type = ? and res_version = ? "
    ...
    invoke-static {v6, v2}, Lcn/com/xy/sms/sdk/util/JsonUtil;->getValueFromJsonObject(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string v6, "res_type = ? and res_version = ? "
    ...
    invoke-static {v2, v7, v6, v8}, Lcn/com/xy/sms/sdk/db/DBManager;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_3
    .catch Ljava/lang/Throwable; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
...
.method public static b(I)Ljava/lang/String;
    ...
    const-string v3, " ORDER BY res_version desc LIMIT 1 "
...
.method private static b(Lorg/json/JSONObject;)V
    ...
    const-string v5, "res_type = ? and res_version = ? "
