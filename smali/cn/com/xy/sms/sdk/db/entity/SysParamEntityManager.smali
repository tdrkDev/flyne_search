...
.method public static deleteOldFile()V
    ...
    const-string v1, "ParseUtilCasual_"

    const-string v2, ".jar"

    const/4 v3, 0x0

    invoke-static {v0, v1, v2, v3}, Lcn/com/xy/sms/sdk/util/f;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "ParseUtilEC_"
    ...
    const-string v1, "ParseUtilFinanceL_"
    ...
    const-string v1, "ParseUtilFinanceM_"
    ...
    const-string v1, "ParseUtilFinanceS_"
    ...
    const-string v1, "ParseUtilLife_"
    ...
    const-string v1, "ParseUtilMove_"
    ...
    const-string v1, "ParseUtilTelecom_"
    ...
    const-string v1, "ParseUtilTravel_"
    ...
    const-string v1, "ParseUtilUnicom_"
    ...
    const-string v0, "ParseUtilCasual_"
    ...
    const-string v0, "ParseUtilFinanceL_"
    ...
    const-string v0, "ParseUtilFinanceM_"
    ...
    const-string v0, "ParseUtilFinanceS_"
    ...
    const-string v0, "ParseUtilLife_"
    ...
    const-string v0, "ParseUtilMove_"
    ...
    const-string v0, "ParseUtilTelecom_"
    ...
    const-string v0, "ParseUtilTravel_"
    ...
    const-string v0, "ParseUtilUnicom_"
...
.method public static getLongParam(Ljava/lang/String;JLandroid/content/Context;)J
    ...
    invoke-static {p0, v1}, Lcn/com/xy/sms/sdk/db/entity/SysParamEntityManager;->setParam(Ljava/lang/String;Ljava/lang/String;)J
    :try_end_2
...
.method public static initParams(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;ZZLjava/util/Map;)V
    ...
    const-string v3, "smartsms_enhance"
    ...
    :cond_1
    const-string v4, "smartsms_enhance"
    ...
    const-string v5, "smartsms_enhance"
    ...
    :cond_4
    const-string v4, "SUPPORT_NETWORK_TYPE"
    ...
    const-string v5, "SUPPORT_NETWORK_TYPE"

    invoke-virtual {v4, v5, v3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_5
    const-string v3, "ONLINE_UPDATE_SDK_PERIOD"
    ...
    :cond_7
    const-string v4, "ONLINE_UPDATE_SDK_PERIOD"
    ...
    const-string v5, "ONLINE_UPDATE_SDK_PERIOD"

    invoke-virtual {v4, v5, v3}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    const-string v3, "PRELOADENABLE"
    ...
    const-string v4, "SMSLOCATEENABLE"
    ...
    :cond_9
    const-string v3, "CUSTOM_LOCATION_SERVER_URL"
    ...
    const-string v4, "CUSTOM_PUBLIC_SERVER_URL"
    ...
    const-string v5, "CUSTOM_PUBINFO_SERVER_URL"
    ...
    const-string v6, "CUSTOM_SDK_SERVER_URL"
    ...
    const-string v7, "ONLINE_UPDATE_SDK"
    ...
    const-string v10, "RECOGNIZE_LEVEL"
    ...
    const-string v12, "OPEN_POPUP_DRAG"
    ...
    const-string v13, "AUTO_UPDATE_DATA"
    ...
    const-string v11, "POPUP_BG_TYPE"
    ...
    const-string v14, "SCENE_CENSUS_ONLINE"
    ...
    const-string v15, "CUSTOM_SDK_RES_DOWNLAOD_URL"
    ...
    const-string v16, "SUPPORT_NETWORK_TYPE_MAJOR"
    ...
    const-string v17, "ONLINE_UPDATE_RES_PERIOD"
    ...
    const-string v18, "REPARSE_BUBBLE_CYCLE"
    ...
    const-string v19, "COMPARE_PUBNUM_OPERATOR"
    ...
    :cond_b
    const-string v20, "CUSTOM_LOCATION_SERVER_URL"
    ...
    const-string v21, "CUSTOM_LOCATION_SERVER_URL"
    ...
    :cond_d
    const-string v6, "CUSTOM_PUBINFO_SERVER_URL"
    ...
    const-string v20, "CUSTOM_PUBINFO_SERVER_URL"
    ...
    const-string v6, "CUSTOM_PUBLIC_SERVER_URL"
    ...
    :goto_3
    const-string v4, "CUSTOM_SDK_SERVER_URL"
    ...
    :goto_5
    const-string v4, "CUSTOM_SDK_RES_DOWNLAOD_URL"
    ...
    const-string v6, "CUSTOM_SDK_RES_DOWNLAOD_URL"
    ...
    :goto_6
    const-string v4, "ONLINE_UPDATE_SDK"
    ...
    const-string v6, "ONLINE_UPDATE_SDK"
    ...
    :goto_8
    const-string v4, "SCENE_CENSUS_ONLINE"
    ...
    const-string v6, "SCENE_CENSUS_ONLINE"
    ...
    :goto_9
    const-string v4, "RECOGNIZE_LEVEL"
    ...
    const-string v6, "RECOGNIZE_LEVEL"
    ...
    const-string v6, "OPEN_POPUP_DRAG"
    ...
    :goto_b
    const-string v4, "AUTO_UPDATE_DATA"
    ...
    const-string v6, "AUTO_UPDATE_DATA"
    ...
    :goto_d
    const-string v4, "SUPPORT_NETWORK_TYPE_MAJOR"
    ...
    const-string v6, "SUPPORT_NETWORK_TYPE_MAJOR"
    ...
    :goto_e
    const-string v4, "ONLINE_UPDATE_RES_PERIOD"
    ...
    const-string v6, "ONLINE_UPDATE_RES_PERIOD"
    ...
    :goto_f
    const-string v4, "REPARSE_BUBBLE_CYCLE"
    ...
    const-string v6, "REPARSE_BUBBLE_CYCLE"
    ...
    const-string v6, "COMPARE_PUBNUM_OPERATOR"
    ...
    invoke-direct {v3, v4, v6}, Lcn/com/xy/sms/sdk/queue/k;-><init>(I[Ljava/lang/String;)V
    ...
    const-string v3, "CUSTOM_LOGO_DOWN_URL"
    ...
    sput-object v3, Lcn/com/xy/sms/sdk/net/NetUtil;->BIZPORT_DOWN_URL:Ljava/lang/String;
...
.method public static queryKeyValue(Ljava/lang/String;[Ljava/lang/String;I)Ljava/util/Map;
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static queryKeyValueByPextend(Ljava/lang/String;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1, v2}, Lcn/com/xy/sms/sdk/db/entity/SysParamEntityManager;->queryKeyValue(Ljava/lang/String;[Ljava/lang/String;I)Ljava/util/Map;
...
.method public static queryValueParamKey(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3}, Lcn/com/xy/sms/sdk/db/entity/SysParamEntityManager;->queryKeyValue(Ljava/lang/String;[Ljava/lang/String;I)Ljava/util/Map;
