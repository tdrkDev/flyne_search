...
!function (e){
    ...
    z.getPara = function (a,b){
        return (a.match(new RegExp("(?:^\\?|&|#)" + b + "=(.*?)(?=&|$)")) || ['', null])[1];
    },z.getQueryPara = function (a){
        return this.getPara(document.location.search,a);
    },z.getHash = function(a){
        var e = location.hash;
        if(e){
            return typeof a == 'string'? this.getPara(e,a):function (b){
                var t = {};
                for (var n = b.substring(1).split("&"), i = 0; i < n.length; i++) {
                    var r = n[i].split("=");
                    t[r[0]] = r[1]
                }
                return t
    ...
    },z.setHash = function (a){
        var h ='';
        if(a && typeof a == 'object'){
            for (var o in a) h += o + '=' + a[o] + '&';
            location.href = '#' + h.substring(0, h.length - 1);
        }
    };
}(Zepto),function(t){
